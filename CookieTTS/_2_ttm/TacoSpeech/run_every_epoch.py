...
varpred_hdn_NLL_weight = 0.01

f_fesvd_MAE_weight = 0.0
f_fesvd_MSE_weight = 1.0
...
# HiFiGAN
HiFiGAN_learning_rate = 0.# base/initial learning rate for HiFiGAN weights # set to 0. to use learning_rate from generator model.
