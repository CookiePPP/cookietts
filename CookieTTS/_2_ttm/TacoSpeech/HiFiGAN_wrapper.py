...
class HiFiGAN(nn.Module):
    def __init__(self, hparams=None):
        ...
        if hparams is None:
            return
        assert hparams.batch_size>=hparams.HiFiGAN_batch_size, 'HiFiGAN batch size must be even or greater than TacoSpeech batch size!'
        self.input_dim = hparams.memory_bottleneck_dim
