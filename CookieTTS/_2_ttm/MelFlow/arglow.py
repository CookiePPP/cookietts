...
class ARFlow(nn.Module):
    ...
    WN_config, cond_res_rezero=False, cond_activation_func=nn.LeakyReLU(0.1, inplace=True), channel_mixing='1x1conv',
    mix_first=True, causal_ar=True, shift_spect=0., scale_spect=1., z_channel_multiplier=2):
        ...
        if causal_ar:
            from CookieTTS._2_ttm.MelFlow.arglow_modules import WaveFlowCoupling as AffineCouplingBlock
            from CookieTTS._2_ttm.MelFlow.arglow_modules import WN_2d as WN
        else:
        ...
        if self.channel_mixing == '1x1conv':
            ...
            from CookieTTS._2_ttm.MelFlow.arglow_modules import PermuteHeight
            self.convinv = list()
