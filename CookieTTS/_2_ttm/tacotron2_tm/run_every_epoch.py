...
dbGAN_dLoss_weight = dbGAN_gLoss_weight*0.5              # De-Blur-GAN Discriminator Loss
...
teacher_force_till = 758# slowly decay this value when InfGAN is implemented and used.
