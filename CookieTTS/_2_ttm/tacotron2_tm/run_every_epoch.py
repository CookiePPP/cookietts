...
res_enc_gMSE_weight = 0.1000# negative classification/regression weight for discriminator.
res_enc_dMSE_weight = 0.1000# positive classification/regression weight for discriminator.
