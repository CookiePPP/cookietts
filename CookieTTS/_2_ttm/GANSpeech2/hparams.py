...
def create_hparams(hparams_string=None, verbose=False):
    ...
    hparams = HParams(
        ...
        emotion_classes = ['Confused', 'Shouting', 'Anxious', 'Surprised',
                           'Whining', 'Annoyed', 'Serious', 'Crazy',
                           'Happy', 'Smug', 'Sarcastic', 'Angry',
                           'Singing', 'Love', 'Rap', 'Tired', 
                           'Disgust','Neutral','Whispering', 'Sad',
                           'Amused', 'Fear',]
        ...
        f0s_ff_dim         =  768,
        f0s_n_layers       =    3,
        f0s_ff_kernel_size =    3,
        
        # F0sDiscriminator Params
        d_f0s_hidden_dim     =  256,
        d_f0s_n_heads        =    2,
        d_f0s_ff_dim         =  768,
        d_f0s_n_layers       =    3,
        d_f0s_ff_kernel_size =    3,
        d_f0s_n_pre_layers   =    0,
