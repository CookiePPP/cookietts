...
###################################################################################################################################
## GANSpeech ## GANSpeech ## GANSpeech ## GANSpeech ## GANSpeech ## GANSpeech ## GANSpeech ## GANSpeech ## GANSpeech ## GANSpeech # 
###################################################################################################################################
...
checkpoint_interval = 250000#validation_interval
...
g_dur_MAE_weight   = rec_scalar* dur_scalar* 1.00
g_dur_MSE_weight   = rec_scalar* dur_scalar* 0.00
g_logf0_MAE_weight = rec_scalar* dur_scalar* 1.00
g_logf0_MSE_weight = rec_scalar* dur_scalar* 0.00
...
g_class_cf0_weight = 0.09
d_class_cf0_weight = 0.09 *2.0
cf0_noise_std = 1.0# noise added to the inputs. Will reduce discriminator accuracy but can help
                   # the generator learn better by giving the generator more opportunities to improve.

g_class_mel_weight = 0.09
d_class_mel_weight = 0.09 *2.0

g_class_dur_active_thresh = 0.20# value required for this term to be added to the total loss. Skipping updates from an unbalanced GAN *might* restabilize it.
g_class_f0s_active_thresh = 0.20# value required for this term to be added to the total loss. Skipping updates from an unbalanced GAN *might* restabilize it.
g_class_mel_active_thresh = 0.20# value required for this term to be added to the total loss. Skipping updates from an unbalanced GAN *might* restabilize it.
d_class_dur_active_thresh = 0.20# value required for this term to be added to the total loss. Skipping updates from an unbalanced GAN *might* restabilize it.
d_class_f0s_active_thresh = 0.20# value required for this term to be added to the total loss. Skipping updates from an unbalanced GAN *might* restabilize it.
d_class_mel_active_thresh = 0.20# value required for this term to be added to the total loss. Skipping updates from an unbalanced GAN *might* restabilize it.
