...
def create_hparams(hparams_string=None, verbose=False):
    ...
    hparams = tf.contrib.training.HParams(
        ...
        prenet_dim=128,       # original 256
        p_prenet_dropout=0.5, # definitely want to test out
        max_decoder_steps=3500,
        gate_threshold=0.5,
        p_AttRNN_hidden_dropout=0.1, #original 0.1
        p_AttRNN_cell_dropout=0.0,   #original 0.0
        p_DecRNN_hidden_dropout=0.1, #original 0.1
        p_DecRNN_cell_dropout=0.0,   #original 0.0
        ...
        attention_dim=128, # 128 2 Layer original
        num_att_mixtures=5, # 5 original
        normalize_attention_input=False,
        ...
        batch_size=90, # 32*3 = 0.377 val loss, # 2 = 0.71 val loss
        val_batch_size=90, # for more precise comparisons between models, constant batch_size is useful
