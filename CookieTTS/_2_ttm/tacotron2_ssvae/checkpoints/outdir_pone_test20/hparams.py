...
def create_hparams(hparams_string=None, verbose=False):
    ...
    hparams = tf.contrib.training.HParams(
        ...
        ignore_layers=["decoder.attention_layer.query_layer.linear_layer.weight", "decoder.attention_layer.memory_layer.linear_layer.weight", "decoder.attention_layer.v.linear_layer.weight", "decoder.attention_layer.location_layer.location_conv.conv.weight", "decoder.attention_layer.location_layer.location_dense.linear_layer.weight"],
        ...
        decoder_rnn_dim=2048, # main decoder param # 1024 original
        prenet_dim=256, # original 256
        p_prenet_dropout=0.5, # definitely want to test out
        ...
        attention_rnn_dim=1536, # 1024 original
        attention_dim=2048,
        num_att_mixtures=1,
        ...
        # Speaker embedding
        n_speakers=512,
        speaker_embedding_dim=128, # speaker embedding size # 128 original
        ...
        batch_size=52, # 32*3 = 0.377 val loss, # 2 = 0.71 val loss
        val_batch_size=52, # for more precise comparisons between models, constant batch_size is useful
