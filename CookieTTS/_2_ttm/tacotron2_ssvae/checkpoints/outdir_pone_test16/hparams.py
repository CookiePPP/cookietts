...
def create_hparams(hparams_string=None, verbose=False):
    ...
    hparams = tf.contrib.training.HParams(
        ...
        ignore_layers=["decoder.attention_rnn.weight_ih","decoder.attention_layer.memory_layer.linear_layer.weight","decoder.decoder_rnn.weight_ih","decoder.decoder_rnn.weight_hh","decoder.decoder_rnn.bias_ih","decoder.decoder_rnn.bias_hh","decoder.linear_projection.linear_layer.weight","decoder.gate_layer.linear_layer.weight","speaker_embedding.weight"],
        ...
        batch_size=36, # 32*3 = 0.377 val loss, # 2 = 0.71 val loss
