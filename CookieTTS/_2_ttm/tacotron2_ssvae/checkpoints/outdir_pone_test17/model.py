...
class Decoder(nn.Module):
    ...
    def decode(self, decoder_input, attention_weights=None):
        ...
        self.attention_weights_cum += self.attention_weights # cumulative weights determine how much time has been spent on each phoneme/char, help keep the model moving in a straight direction
