...
def create_hparams(hparams_string=None, verbose=False):
    ...
    hparams = tf.contrib.training.HParams(
        ...
        ignore_layers=["decoder.decoder_rnn.weight_ih","decoder.decoder_rnn.weight_hh","decoder.decoder_rnn.bias_ih","decoder.decoder_rnn.bias_hh","decoder.linear_projection.linear_layer.weight","decoder.gate_layer.linear_layer.weight","decoder.linear_projection_pre.linear_layer.weight", "decoder.linear_projection_pre.linear_layer.bias"],
        ...
        attention_dim=256, # 128 original
        ...
        batch_size=38, # 32*3 = 0.377 val loss, # 2 = 0.71 val loss
        val_batch_size=38, # for more precise comparisons between models, constant batch_size is useful
