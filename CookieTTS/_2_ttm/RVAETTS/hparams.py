...
def create_hparams(hparams_string=None, verbose=False):
    ...
    hparams = HParams(
        ...
        ###################################
        data_source = 1,# 0 to use nvidia/RVAETTS filelists, 1 to use automatic dataset processor
        ...
        # Variational Mel Encoder
        vmelenc_n_tokens = 8,
        vmelenc_seglstm_dim       = 512,
        vmelenc_seglstm_n_layers  =   2,
        vmelenc_resblock_n_layers =   3,
        vmelenc_resblock_n_dim    = 512,
        vmelenc_resblock_n_blocks =   2,
        vmelenc_resblock_kernel_w =   1,
        
        # VAE Variance Predictor
        varpred_n_tokens = 8,
        varpred_lstm_dim      = 512,
        varpred_lstm_n_layers =   3,
        ...
        HiFiGAN_batch_size  =     2,# affects VRAM usage
