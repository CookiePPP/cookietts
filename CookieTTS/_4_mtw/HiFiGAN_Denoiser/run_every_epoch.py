...
hrs_elapsed = max(  0, (seconds_elapsed-(hr*24))//hr  ) # start dropping Learning Rate 24 hours after training starts.
...
A_ = 0.0000100
A_ = A_/(2**(hrs_elapsed/6))# LR updates every hour, half-life of 12 hours.
B_ = 80000
C_ = 0.0000000
d_lr_scale = 100. # scale distriminator LR by this amount.

warmup_start = 100
warmup_end   = warmup_start + 450
