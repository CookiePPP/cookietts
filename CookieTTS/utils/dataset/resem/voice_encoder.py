...
class VoiceEncoder(nn.Module):
    ...
    def get_embed_from_path(self, audiopath):
        audio, sr = load_wav_to_torch(audiopath, target_sr=sampling_rate)
        audio = update_loudness(audio, sampling_rate=sampling_rate, target_lufs=-24.0)
        embed = self.embed_utterance(audio.numpy())
...
def update_loudness(audio, sampling_rate=16000, target_lufs=-27.0, original_lufs=None):
