...
def process_rq_result(result):
    ...
    out['global_sigma']        = float(result.get(  'input_global_sigma'))
    out['char_sigma']          = float(result.get(  'input_char_sigma'  ))
    out['frame_sigma']         = float(result.get(  'input_frame_sigma' ))
...
def texttospeech():
    if request.method == 'POST':
        ...
        return render_template('main.html',
                                ...
                                global_sigma        = tts_dict['global_sigma'],
                                char_sigma          = tts_dict['char_sigma'],
                                frame_sigma         = tts_dict['frame_sigma'],
...
def show_entries():
    return render_template(
        ...
        global_sigma        = conf['webpage']['defaults']['global_sigma'],
        char_sigma          = conf['webpage']['defaults']['char_sigma'],
        frame_sigma         = conf['webpage']['defaults']['frame_sigma'],
        gen_time   = "",
        gen_dur    = "",
        total_specs= "",
        n_passes   = "",
