...
def process_rq_result(result):
    ...
    out['sigma']               = float(result.get(  'input_sigma'            ))
    out['randn_max']           = float(result.get(  'input_randn_max'        ))
...
def texttospeech():
    if request.method == 'POST':
        ...
        return render_template('main.html',
                                ...
                                sigma               = tts_dict['sigma'],
                                randn_max           = tts_dict['randn_max'],
...
def show_entries():
    return render_template(
        ...
        sigma               = conf['webpage']['defaults']['sigma'],
        randn_max           = conf['webpage']['defaults']['randn_max'],
